...
from custom_components.custom_lighting import const

folder = Path("custom_components") / "custom_lighting"
...
# Set "services"
services_filename = Path("custom_components") / "custom_lighting" / "services.yaml"
