...
VALIDATION_TUPLES: list[tuple[str, Any, Any]] = [
    ...
    (CONF_TIME_POINT_5, NONE_STR, str),
    (CONF_TIME_POINT_6, NONE_STR, str),
    ...
    (CONF_TIME_BRIGHTNESS_5, DEFAULT_TIME_BRIGHTNESS, int_between(1, 100)),
    (CONF_TIME_BRIGHTNESS_6, DEFAULT_TIME_BRIGHTNESS, int_between(1, 100)),
    ...
    (CONF_TIME_COLOR_TEMP_5, DEFAULT_TIME_COLOR_TEMP_5, int_between(1000, 10000)),
    (CONF_TIME_COLOR_TEMP_6, DEFAULT_TIME_COLOR_TEMP_6, int_between(1000, 10000)),
]
...
EXTRA_VALIDATION: dict[str, tuple[Any, Any]] = {
    ...
    CONF_TIME_POINT_5: (cv.time, str),
    CONF_TIME_POINT_6: (cv.time, str),
}
